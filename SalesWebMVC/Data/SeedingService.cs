...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; // Se a DB possuir algum conteúdo, o metódo Seed não fará nada.
            }
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 1500.0, new DateTime(1979, 12, 31), d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", 10000.0, new DateTime(1998, 1, 15), d3);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", 4000.0, new DateTime(1993, 11, 30), d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", 3000.0, new DateTime(2000, 1, 9), d1);
            ...
            SalesRecord r9 = new SalesRecord(9, new DateTime(2018, 09, 14), 11000.0, SaleStatus.PENDING, s3);
            ...
            SalesRecord r20 = new SalesRecord(20, new DateTime(2018, 10, 15), 8000.0, SaleStatus.BILLED, s5);
